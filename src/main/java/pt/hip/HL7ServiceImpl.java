...
@WebService(endpointInterface = "pt.hip.HL7Service")
public class HL7ServiceImpl implements HL7Service {
    ...
    @Override
    public String getMSHDate(String exchange) throws ParseException {
        String dateString = "";
        MSH mshSegment = null;
        try {
    ...
    private Message hl7ParserFromString(String exchangeBody) throws HL7Exception {
